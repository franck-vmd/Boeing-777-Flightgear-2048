...
var mfdReload= func() {
    ...
    mfdDel();
    io.load_nasal(getprop("/sim/fg-root") ~ "/Aircraft/777-VMD/Models/Instruments/MFD-F/mfd.nas","b777");
    io.load_nasal(getprop("/sim/fg-root") ~ "/Aircraft/777-VMD/Models/Instruments/MFD-F/fuel.nas","b777");
    mfdCreate();
}
